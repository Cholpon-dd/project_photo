        ...
        <>
           ...
           <div className="container">
            <div className="about-me">  
                ...
                <div>
                     <h6 className="about-me-title">Добро пожаловать на мою страницу!! Меня зовут Эльвира и я фотограф. Хороший детский и семейный фотограф — это не просто «человек, который может сфотографировать всю семью». Совершенно особыми членами семьи являются дети.<br/> Они на наших глазах учатся улыбаться, ползать, ходить, говорить, ездить на велосипеде. И все это очень важно и значительно – потому что в первый раз. Поймать «самый-самый» момент – это труд, это талант и сочетание множества навыков профессионального детского фотографа.
